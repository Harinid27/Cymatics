...
import financialService, { CreateExpenseData } from '@/src/services/FinancialService';
          ...
          <View style={styles.inputGroup}>
            ...
            >
              <View style={styles.categoryRow}>
                ...
                />
                <Text style={[styles.dropdownText, { color: colors.text }, !formData.category && { color: colors.placeholder }]}>
