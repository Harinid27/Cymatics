...
import EntertainmentService, { CreateEntertainmentData } from '@/src/services/EntertainmentService';
...
export default function CreateEntertainmentScreen() {
  ...
  const [formData, setFormData] = useState<CreateEntertainmentData>({
        ...
        <View style={styles.fieldContainer}>
          ...
          <View style={styles.ratingContainer}>
            ...
            <View style={styles.ratingDisplay}>
              ...
              <View style={[styles.ratingBadge, { backgroundColor: EntertainmentService.getRatingColor(formData.rating) }]}>
        ...
        >
          {isLoading ? (
            ...
            <>
              ...
              <Text style={[styles.saveButtonText, { color: colors.background }]}>Add Entertainment</Text>
            </>
          )}
        </TouchableOpacity>
      </View>
