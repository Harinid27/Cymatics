 ...
 * @access  Private
 */
router.get('/events/stats', calendarController.getCalendarStats);
 ...
 * @access  Private
 */
router.get('/events/week', calendarController.getCurrentWeekEvents);
 ...
 * @access  Private
 */
router.get('/events/month', calendarController.getCurrentMonthEvents);
